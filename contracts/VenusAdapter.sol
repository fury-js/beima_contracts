...
contract VenusAdapter is OwnableService, ReentrancyGuard{
    ...
    using SafeERC20 for IVBUSD; 
     ...
     constructor(address payable serviceContract) public OwnableService(serviceContract){
        _vBUSD = IVBUSD(0xcF47447E343031665fffc703092061C10C1180d9); // Venus BUSD Shares
        _BUSD = IERC20(0x043D1F90f86Fd36dbf8b9be38B0703B8dF83Ecf4); // Pegged-BUSD address on BSC Main Network
     }
